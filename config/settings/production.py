...
ALLOWED_HOSTS = env.list(
    ...
    default=["elastomeros-ecuatorianos.ec"],
)
CSRF_TRUSTED_ORIGINS = env.list(
    "DJANGO_CSRF_TRUSTED_ORIGINS",
    default=["https://elastomeros-ecuatorianos.ec"],
)
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="Elastómeros Ecuatorianos <noreply@elastomeros-ecuatorianos.ec>",
)
SERVER_EMAIL = env(
    "DJANGO_SERVER_EMAIL",
...
EMAIL_SUBJECT_PREFIX = env(
    ...
    default="[Elastómeros Ecuatorianos] ",
)
...
AWS_SES_REGION_NAME = env("DJANGO_AWS_SES_REGION_NAME", default="sa-east-1")
ANYMAIL = {
